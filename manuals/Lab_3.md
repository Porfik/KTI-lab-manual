...
>[!WARNING]
>Здесь и далее любое упоминание `Takumi Fujiwara`, `IU4-XX` и `batman` надо заменять на свои инициалы и номер группы *на английском*, в таком формате соответственно: `Ivan Petrov`, `IU4-12` и `petroviv` соответственно.
