...
>Интересный факт: данные методички тоже хранятся на GitHub, поэтому вы можете скачать их на свои компьютеры с помощью GIT и хранить локально, главное периодически их обновлять. А ещё вы можете поставить звёздочку на этот репозиторий с методами :)
