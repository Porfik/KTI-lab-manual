...
После установки гипервизора (данный этап был описан здесь: [подготовка к лабораторным работам](manuals/Preparation_for_labs.md)) на вашем ПК будут доступны следующие программы:
...
Перед началом работы непосредственно с гипервизором проверим настройки виртуальных сетей. Для этого откроем Virtual Network Editor с *правами администратора*, так как она вносит изменения в конфигурацию сетевых адаптеров хоста.
...
Давайте проверим присутствие соответствующих сетевых интерфейсов на хосте (вашем ПК). В случае Windows проверить это можно открыв PowerShell (оболочка командной строки Windows) и введя команду:
```bash
